...
export const calculateCarbonFootprint = functions.firestore
  ...
  .onCreate(async (snap, context) => {
    ...
    try {
      ...
      Format Language: your response should be in ${product.country} languag, including number and the translated name for CO2e.
      ...
      const adviceQuery = `
        ...
        your response should be in ${product.country} language.
        `;
